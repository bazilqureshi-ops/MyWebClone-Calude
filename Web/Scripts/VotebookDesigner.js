...
$(document).ready(function () {
	...
	var area_height = (area_width * 10) / 16;
	...
	elementAction(pageBackground, triggerType, timeOutTime, 'close');
...
function modalActive(element) {
	...
	if (typeOfElement === 'Label') {
		//Opening Elements
		elementAction(dataBind, elementCaption, fontSize, fontStyle, fontColour, align, vAlign, bold, italic, underline, 'open');
	...
	else if (typeOfElement === 'QuestionArea') {
		//Opening Elements
		elementAction(fontSize, fontStyle, fontColour, align, vAlign, bold, italic, underline, 'open');
	...
	else if (typeOfElement === 'AnswerArea') {
		//Opening Elements
		elementAction(fontSize, fontStyle, fontColour, align, vAlign, bold, italic, underline, 'open');
	...
	else if (typeOfElement === 'PreviousButton') {
		//Opening Elements
		elementAction(elementType, elementId, elementName, elementBackground, positionX, positionY, sizeX, sizeY, 'open');
		...
		elementBackground.val((currentElement.attr('background-image')));
	}
	else if (typeOfElement === 'NextButton') {
		//Opening Elements
		elementAction(elementType, elementId, elementName, elementBackground, positionX, positionY, sizeX, sizeY, 'open');
		...
		elementAction(pageBackground, triggerType, timeOutTime, 'open');
...
function createElement(elementtype) {
	...
	if (elementtype === "Label") {
		localElement = $('<div class="uiElement" data-bind="Static" style="position:absolute; width: 50px; height: 50px; left:0; top:0; font-size:48px; width:150px; height:75px; border:dotted 2px #CCC; cursor:pointer; color:rgb(0,0,0); line-height:100%" type="Label"  name="Label' + ElementCount + '" id="' + ElementCount + '"><a onclick="modalActive($(this).parent())"><i class="fa fa-edit design-icons" ></i></a><span onclick="deleteItem($(this))" class="fa fa-trash design-icons text-danger"></span><label>label' + ElementCount + '</label></div>');
	}
		...
		localElement = $('<div class="uiElement" righttoleft="false" tickrate="60" tickpercentage="60" style="position:absolute; width: 50px; height: 50px; left:0; top:0; border:dotted 2px #CCC; cursor:pointer; line-height:100%" type="ScrollText" name="ScrollText' + ElementCount + '" id="' + ElementCount + '"><marquee>Scroll Text Message</marquee><a onclick="modalActive($(this).parent())"><i class="fa fa-edit design-icons" ></i></a><span onclick="deleteItem($(this))" class="fa fa-trash design-icons text-danger"></span></div>');
	}
	else if (elementtype === "RSSFeed") {
		localElement = $('<div class="uiElement text-center" datasource="" autoscroll="true" rowcount="10" rowname="" rowmap="channel>item" refleshtime="30" style="position:absolute; width: 50px; height: 50px; left:0; top:0; border:dotted 2px #CCC; cursor:pointer;" type="RSSFeed" name="RSSFeed' + ElementCount + '" id="' + ElementCount + '"><a onclick="modalActive($(this).parent())"><i class="fa fa-edit design-icons" ></i></a><span class="fa fa-rss" style="font-size:128px;"></span><span onclick="deleteItem($(this))" class="fa fa-trash design-icons text-danger"></span></div>');
	}
	else if (elementtype === "DateTime") {
		localElement = $('<div class="uiElement" showdate="true" showtime="true" style="position:absolute; width: 50px height: 50px; left:0; top:0; border:dotted 2px #CCC; font-size:18px; cursor:pointer; line-height:100%" type="DateTime" name="DateTime' + ElementCount + '" id="' + ElementCount + '"><a onclick="modalActive($(this).parent())"><i class="fa fa-edit design-icons" ></i></a> 00.00.0000 00:00:00<span onclick="deleteItem($(this))" class="fa fa-trash design-icons text-danger"></span></div>');
	}
	else if (elementtype === 'QuestionArea') {
		localElement = $('<div class="uiElement" style="position:absolute; left:0; top:0; width: 150px; height: 75px; border:dotted 2px #CCC; cursor:pointer; color:rgb(0,0,0); line-height:100%;" type="QuestionArea" name="QuestionArea' + ElementCount + '" id="' + ElementCount + '"> <a onclick="modalActive($(this).parent())"><i class="fa fa-edit design-icons" ></i></a><span onclick="deleteItem($(this))" class="fa fa-trash design-icons text-danger"></span><span class="fa fa-question" style="font-size:64px;"></span></div>');
	}
	else if (elementtype === 'AnswerArea') {
		localElement = $('<div class="uiElement" style="position:absolute; left:0; top:0; width: 90px; height: 75px; border:dotted 2px #CCC; cursor:pointer; color:rgb(0,0,0); line-height:100%;" type="AnswerArea" name="AnswerArea' + ElementCount + '" id="' + ElementCount + '"> <a onclick="modalActive($(this).parent())"><i class="fa fa-edit design-icons" ></i></a><span onclick="deleteItem($(this))" class="fa fa-trash design-icons text-danger"></span><span class="fa fa-list" style="font-size:64px;"></span></div>');
	}
	else if (elementtype === 'PreviousButton') {
		localElement = $('<div class="uiElement" style="position:absolute; left:0; top:0; width: 90px; height: 50px; border:dotted 2px #CCC; cursor:pointer; color:rgb(0,0,0); line-height:100%;" type="PreviousButton" name="PreviousButton' + ElementCount + '" id="' + ElementCount + '" background-image=""> <a onclick="modalActive($(this).parent())"><i class="fa fa-edit design-icons" ></i></a><span onclick="deleteItem($(this))" class="fa fa-trash design-icons text-danger"></span><span class="fa fa-step-backward" style="font-size:32px;"></span></div>');
	}
	else if (elementtype === 'NextButton') {
		localElement = $('<div class="uiElement" style="position:absolute; left:0; top:0; width: 90px; height: 50px; border:dotted 2px #CCC; cursor:pointer; color:rgb(0,0,0); line-height:100%;" type="NextButton" name="NextButton' + ElementCount + '" id="' + ElementCount + '" background-image=""> <a onclick="modalActive($(this).parent())"><i class="fa fa-edit design-icons" ></i></a><span onclick="deleteItem($(this))" class="fa fa-trash design-icons text-danger"></span><span class="fa fa-step-forward" style="font-size:32px;"></span></div>');
	}
...
function ConvertToMagic() {
	var triggerType = $("#trigger-type").val();
	var timeOut = $("#operation-timeout").val();

	var TheCode = "<Design>\n";
	TheCode = TheCode + '\t<Page type="VotebookPage" name="' + pageTitle.val() + '" BackgroundImage="' + pageBackground.val() + '" Trigger="' + triggerType + '" Timeout="' + timeOut + '">\n\n';
	...
	$("#DesignArea").children('.uiElement').each(function () {
		...
		if (element_type === "Label") {
			...
			TheCode += '\t\t<Type>'+element_action+'</Type>\n';
		...
		else if (element_type === "QuestionArea") {
			//let element_parameter = element.attr("parameter");
			let element_font = element.css("font-family").replace(/"/g, '');
			let element_fontsize = element.css("font-size");
			let element_color = element.css("color");
			...
			TheCode += '\t<Control type="QuestionArea">\n';
			TheCode += '\t\t<Identifier>' + element_id + '</Identifier>\n';
			TheCode += '\t\t<Name>' + element_name + '</Name>\n';
			TheCode += '\t\t<PositionX>' + element_positionx + '</PositionX>\n';
			TheCode += '\t\t<PositionY>' + element_positiony + '</PositionY>\n';
		...
		else if (element_type === "AnswerArea") {
			//let element_parameter = element.attr("parameter");
			let element_font = element.css("font-family").replace(/"/g, '');
			let element_fontsize = element.css("font-size");
			let element_color = element.css("color");
			...
			TheCode += '\t<Control type="AnswerArea">\n';
			TheCode += '\t\t<Identifier>' + element_id + '</Identifier>\n';
			TheCode += '\t\t<Name>' + element_name + '</Name>\n';
			TheCode += '\t\t<PositionX>' + element_positionx + '</PositionX>\n';
			TheCode += '\t\t<PositionY>' + element_positiony + '</PositionY>\n';
		...
		else if (element_type === "PreviousButton") {
			let element_bg = element.attr("background-image");

			TheCode += '\t<Control type="PreviousButton">\n';
			TheCode += '\t\t<Type>PreviousButton</Type>\n';
			TheCode += '\t\t<Identifier>' + element_id + '</Identifier>\n';
			TheCode += '\t\t<Name>' + element_name + '</Name>\n';
			TheCode += '\t\t<PositionX>' + element_positionx + '</PositionX>\n';
			TheCode += '\t\t<PositionY>' + element_positiony + '</PositionY>\n';
			TheCode += '\t\t<Width>' + element_width + '</Width>\n';
			TheCode += '\t\t<Height>' + element_height + '</Height>\n';
			TheCode += '\t\t<BackgroundImage>' + element_bg + '</BackgroundImage>\n';
			TheCode += "\t</Control>\n\n";
		}
		else if (element_type === "NextButton") {
			let element_bg = element.attr("background-image");

			TheCode += '\t<Control type="NextButton">\n';
			TheCode += '\t\t<Type>NextButton</Type>\n';
			TheCode += '\t\t<Identifier>' + element_id + '</Identifier>\n';
			TheCode += '\t\t<Name>' + element_name + '</Name>\n';
			TheCode += '\t\t<PositionX>' + element_positionx + '</PositionX>\n';
			TheCode += '\t\t<PositionY>' + element_positiony + '</PositionY>\n';
